...
class CorrelationContextManager {
    ...
    static getCurrentContext() {
        ...
        if (!this._isDisabled) {
            ...
            return this.spanToContextObject(activeSpan === null || activeSpan === void 0 ? void 0 : activeSpan.spanContext(), (_c = activeSpan === null || activeSpan === void 0 ? void 0 : activeSpan.parentSpanContext) === null || _c === void 0 ? void 0 : _c.spanId, activeSpan === null || activeSpan === void 0 ? void 0 : activeSpan.name, traceStateObj);
        }
        return null;
    }
    /**
    ...
    static startOperation(input, request) {
        ...
        if (span) {
            ...
            return this.spanToContextObject(span.spanContext(), (_a = span.parentSpanContext) === null || _a === void 0 ? void 0 : _a.spanId);
        }
        if (spanContext) {
